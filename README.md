...
| :--- | :--- | :--- | :--- | :--- |
| [**vsdb**](strata) | [![Crates.io](https://img.shields.io/crates/v/vsdb.svg)](https://crates.io/crates/vsdb) | [![Docs.rs](https://docs.rs/vsdb/badge.svg)](https://docs.rs/vsdb) | `strata` | High-level, typed data structures (e.g., `Mapx`, `MapxOrd`). This is the primary crate for most users. |
