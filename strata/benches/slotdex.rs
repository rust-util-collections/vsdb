...
fn slot_4(c: &mut Criterion) {
    ...
    group.bench_function("page size: 10", |b| b.iter(|| query(&db, black_box(10))));
    group.bench_function("page size: 20", |b| b.iter(|| query(&db, black_box(20))));
    group.bench_function("page size: 40", |b| b.iter(|| query(&db, black_box(40))));
    group.bench_function("page size: 80", |b| b.iter(|| query(&db, black_box(80))));
